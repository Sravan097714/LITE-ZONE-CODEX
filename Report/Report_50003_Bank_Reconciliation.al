report 50003 "Bank Reconciliation Report"
{
    ...
    dataset
    {
        dataitem(HeaderSection; Integer)
        {
            ...
            column(BalAsPerBankStatement_; BankAcctLedEntryOpeningBal."Amount (LCY)" + BankAcctLedEntryOpeningBal2."Amount (LCY)") { }
            column(BalAsPerBankStatement_2; BankAcctLedEntryOpeningBal.Amount + BankAcctLedEntryOpeningBal2.Amount) { }
        ...
        dataitem("Bank Account Ledger Entry"; "Bank Account Ledger Entry")
        {
            ...
            begin
                ...
                "Bank Account Ledger Entry".SETFILTER("Source Code", '<>%1&<>%2', 'FINVOIDCHK', 'EXCHRATADJ');
    ...
    begin
        ...
        BankAcctLedEntryOpeningBal.CALCSUMS(Amount);

        //RCTS 02/02/21
        BankAcctLedEntryOpeningBal2.RESET;
        BankAcctLedEntryOpeningBal2.SETCURRENTKEY("Statement Status", "Posting Date", "Bank Account No.");
        BankAcctLedEntryOpeningBal2.SETRANGE("Bank Account No.", "BankAccNo.");
        BankAcctLedEntryOpeningBal2.SETFILTER("Posting Date", '<=%1', DateG);
        BankAcctLedEntryOpeningBal2.SetRange("Source Code", 'EXCHRATADJ');
        BankAcctLedEntryOpeningBal2.CALCSUMS("Amount (LCY)");
        BankAcctLedEntryOpeningBal2.CALCSUMS(Amount);
    end;
    ...
    var
        ...
        BankAcctLedEntryOpeningBal2: Record "Bank Account Ledger Entry";
        Counter: Integer;
