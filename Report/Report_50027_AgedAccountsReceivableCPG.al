report 50027 "Aged Accounts Receivable CPG"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Report\Layout\AgedAccountsReceivableCPG.rdl';
    ApplicationArea = Basic, Suite;
    Caption = 'Aged Accounts Receivable with Customer Posting Group';
            ...
            dataitem(Customer; Customer)
            {
                ...
                dataitem(CurrencyLoop; "Integer")
                {
                    ...
                    dataitem(TempCustLedgEntryLoop; "Integer")
                    {
                        ...
                        column(CustomerPostingGrp; Customer."Customer Posting Group") { }
    ...
    var
        ...
        AgedAccReceivableCptnLbl: Label 'Aged Accounts Receivable with Customer Posting Group';
