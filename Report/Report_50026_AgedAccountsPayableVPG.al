report 50026 "Aged Accounts Payable VPG"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Report\Layout\AgedAccountsPayableVPG.rdl';
    ApplicationArea = Basic, Suite;
    Caption = 'Aged Accounts Payable with Vendor Posting Group';
        ...
        dataitem(Vendor; Vendor)
        {
            ...
            dataitem(CurrencyLoop; "Integer")
            {
                ...
                dataitem(TempVendortLedgEntryLoop; "Integer")
                {
                    ...
                    column(VendorPostingGrp; Vendor."Vendor Posting Group") { }
    ...
    var
        ...
        AgedAcctPayableCaptionLbl: Label 'Aged Accounts Payable with Vendor Posting Group';
