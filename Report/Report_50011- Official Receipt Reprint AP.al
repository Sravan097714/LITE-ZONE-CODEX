report 50050 "Official Receipt Reprint AP"
{

    DefaultLayout = RDLC;
    Caption = 'Official Receipt Reprint After Application';
    RDLCLayout = 'Report\Layout\Official Receipt 2 Reprint Application.rdl';
