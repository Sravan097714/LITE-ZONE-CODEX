...
{
    RDLCLayout = 'Report\Layout\Standard Statement.rdl';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            column(BRN; BRN) { }
            column(CompanyInfo; CompanyInfo."Postal Address") { }
            ...
            dataitem("Integer"; Integer)
            {
                ...
                column(CompanyInfoEmail; CompanyInfo."Sales Invoice Email")
                {
                }
                ...
                dataitem(CurrencyLoop; Integer)
                {
                    ...
                    dataitem(CustLedgEntryHdr; Integer)
                    {
                        ...
                        dataitem(DtldCustLedgEntries; "Detailed Cust. Ledg. Entry")
                        {
                            ...
                            column(gtextCustOrderNo; gtextCustOrderNo) { }
                            ...
                            begin
                                ...
                                Clear(gtextCustOrderNo);
                                if "Document Type" = "Document Type"::Invoice then begin
                                    if grecSalesInvHdr.get("Document No.") then begin
                                        if grecSalesInvHdr."Order No." <> '' then
                                            gtextCustOrderNo := grecSalesInvHdr."Order No."
                                        else
                                            gtextCustOrderNo := grecSalesInvHdr."Pre-Assigned No.";
                                    end;
                                end;
                                if "Document Type" = "Document Type"::"Credit Memo" then begin
                                    if grecSalesCrMemoHdr.get("Document No.") then
                                        gtextCustOrderNo := grecSalesCrMemoHdr."Pre-Assigned No.";
                                end;
    ...
    var
        ...
        grecSalesCrMemoHdr: Record "Sales Cr.Memo Header";
        gtextCustOrderNo: Text;
