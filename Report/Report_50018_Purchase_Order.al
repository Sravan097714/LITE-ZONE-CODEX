report 50018 "Purchase Order"
{
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    dataitem(RoundLoop; Integer)
                    {
                        ...
                        column(gtextVendorItemNo; gtextVendorItemNo)
                        {
                        }
                        ...
                        begin
                            ...
                            IF Item.GET("Purchase Line"."No.") THEN BEGIN
                                ...
                                VItemNo := Item."Vendor Item No.";

                                if VItemNo = '' then begin
                                    grecVendorItemCatalogue.reset;
                                    grecVendorItemCatalogue.SetRange("Item No.", "Purchase Line"."No.");
                                    grecVendorItemCatalogue.SetRange("Vendor No.", "Purchase Line"."Buy-from Vendor No.");
                                    if grecVendorItemCatalogue.FindFirst() then
                                        VItemNo := grecVendorItemCatalogue."Vendor Item No.";
                                end;
                            END;
                        end;
                ...
                begin
                    ...
                    Clear(gtextVendorItemNo);
                    if grecItem.Get(PurchLine."No.") then
                        gtextVendorItemNo := grecItem."Vendor Item No.";
            ...
            begin
                ...
                IF Vendor.GET("Purchase Header"."Buy-from Vendor No.") THEN BEGIN
                    ...
                    BuyFromAddr[3] := Vendor."Address 2";
                    BuyFromAddr[4] := Vendor.City;
                    if grecCountry.Get(Vendor."Country/Region Code") then
                        BuyFromAddr[5] := grecCountry.Name;
                END;
                ...
                grecApprovalEntry.Reset();
                grecApprovalEntry.SetRange("Document No.", "No.");
                if grecApprovalEntry.FindLast() then begin
                    User.RESET;
                    User.SETRANGE("User Name", grecApprovalEntry."Approver ID");
    ...
    var
        ...
        VItemNo: Text[50];
        grecVendorItemCatalogue: Record "Item Vendor";
}
