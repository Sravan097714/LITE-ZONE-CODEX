    ...
    dataset
    {
        dataitem("Vendor Ledger Entry"; "Vendor Ledger Entry")
        {
            ...
            dataitem(PageLoop; "Integer")
            {
                ...
                column(Email2; CompanyInfo."Sales Invoice Email") { }
                ...
                column(BankAccountNo; gtextBankAccNo) { }
                column(ReportTitle; ReportTitle) { }
                column(DocNo_VendLedgEntry; "Vendor Ledger Entry"."Document No.") { }
                column(PaymentMethod; gtextPaymentMethodName) { }
                ...
                dataitem(DetailedVendorLedgEntry1; "Detailed Vendor Ledg. Entry")
                {
                    ...
                    dataitem(VendLedgEntry1; "Vendor Ledger Entry")
                    {
                        ...
                        column(VendInvNo; "External Document No.") { }
            ...
            begin
                ...
                if grecBankAcc.get("Bal. Account No.") then begin
                    gtextBankName := grecBankAcc.Name;
                    gtextBankAccNo := grecBankAcc."Bank Account No.";
                end;

                if grecPaymentMethod.Get("Payment Method Code") then begin
                    gtextPaymentMethodName := grecPaymentMethod.Description;
                end;
            end;
