report 50016 "Sales Invoice"
{
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(CurrencyCode_SalesInvoiceHeader; CurrCode) { }
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(CompanyEmail2; CompanyInfo."Sales Invoice Email") { }
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        column(gdecSubTotal; gdecSubTotal) { }
                        ...
                        begin
                            ...
                            gdecSubTotal += "Line Amount";
                            gdecVAT += ("Amount Including VAT" - Amount);
                        end;
