report 50031 "Sales Reservation Avail. LZ"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Report\Layout\SalesReservationAvail2.rdl';
    ApplicationArea = Reservation;
    Caption = 'Sales Reservation Avail. LZ';
    ...
    dataset
    {
        dataitem("Sales Line"; "Sales Line")
        {
            ...
            column(SelltoCust; gtextCustName) { }
            ...
            begin
                clear(gtextCustName);
                if grecCustomer.get("Sales Line"."Sell-to Customer No.") then
