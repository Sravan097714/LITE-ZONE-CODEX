page 50008 "Item List Filtering"
{
    ...
    layout
    {
        area(content)
        {
            ...
            {
                Editable = true;
                field("Item Category Code "; gtextItemCatCode)
                {
                    ApplicationArea = All;
                    Editable = true;
                    ...
                    trigger OnValidate()
                    begin
                        if gtextItemCatCode <> '' then
                            SetRange("Item Category Code", gtextItemCatCode)
                        else
                            SetRange("Item Category Code");
                        CurrPage.Update();
                    end;
                }
                field("Product Group Code "; gtextProdGrpCode)
                {
                    ApplicationArea = All;
                    Editable = true;
                    ...
                    var
                        grecItemProductGrp: Record "Item Product Group";
                        gpageItemProductGrpList: Page "Item Product Groups";
                    begin
                        if gtextItemCatCode <> '' then begin
                            Clear(gpageItemProductGrpList);
                            grecItemProductGrp.Reset();
                            grecItemProductGrp.SetRange("Item Category Code", gtextItemCatCode);
                            if grecItemProductGrp.FindFirst() then begin
                                gpageItemProductGrpList.SetRecord(grecItemProductGrp);
                                gpageItemProductGrpList.SetTableView(grecItemProductGrp);
                                gpageItemProductGrpList.LookupMode(true);
                                if gpageItemProductGrpList.RunModal() = Action::LookupOK then begin
                                    gpageItemProductGrpList.GetRecord(grecItemProductGrp);
                                    gtextProdGrpCode := grecItemProductGrp."Product Group Code";

                                    if gtextProdGrpCode <> '' then
                                        SetRange("Product Group Code 2", gtextProdGrpCode)
                                    else
                                        SetRange("Product Group Code 2");
                                    CurrPage.Update();
                                end;
                            end;
                        end;
                ...
                field("Format "; gtextFormat)
                {
                    ...
                    begin
                        if gtextFormat <> '' then
                            SetRange("Item Type", gtextFormat)
                        else
                            SetRange("Item Type");
                        CurrPage.Update(true);
                    end;
                }
                field("Colour "; gtextColour)
                {
                    ApplicationArea = All;
                    Editable = true;
                    ...
                    begin
                        if gtextColour <> '' then
                            SetRange(Colour, gtextColour)
                        else
                            SetRange(Colour);
                        CurrPage.Update(true);
                    end;
                }
                field("Finish "; gtextFinish)
                {
                    ApplicationArea = All;
                    Editable = true;
                    ...
                    begin
                        if gtextFinish <> '' then
                            SetRange(Finish, gtextFinish)
                        else
                            SetRange(Finish);
                        CurrPage.Update(true);
                    end;
                }
                field("Material "; gtextMaterial)
                {
                    ApplicationArea = All;
                    Editable = true;
                    ...
                    trigger OnValidate()
                    begin
                        if gtextMaterial <> '' then
                            SetRange(Material, gtextMaterial)
                        else
                            SetRange(Material);
                        CurrPage.Update();
                    end;
                }
                field("Dimension "; gtextDimension)
                {
                    ApplicationArea = All;
                    Editable = true;
                    ...
                    trigger OnValidate()
                    begin
                        if gtextDimension <> '' then
                            SetRange(Dimensions, gtextDimension)
                        else
                            SetRange(Dimensions);
                        CurrPage.Update(true);
                    end;
                }
                field("Lampholder "; gtextLampholder)
                {
                    ApplicationArea = All;
                    Editable = true;
                    ...
                    trigger OnValidate()
                    begin
                        if gtextLampholder <> '' then
                            SetRange(Lampholder, gtextLampholder)
                        else
                            SetRange(Lampholder);
                        CurrPage.Update(true);
                    end;
                }
                field("Wattage "; gtextWattage)
                {
                    ApplicationArea = All;
                    Editable = true;
                    ...
                    trigger OnValidate()
                    begin
                        if gtextWattage <> '' then
                            SetRange(Wattage, gtextWattage)
                        else
                            SetRange(Wattage);
                        CurrPage.Update(true);
                    end;
                }
                field("Thickness "; gtextThickness)
                {
                    ApplicationArea = All;
                    Editable = true;
                    ...
                    trigger OnValidate()
                    begin
                        if gtextThickness <> '' then
                            SetRange("ATTRIBUTE 8", gtextThickness)
                        else
                            SetRange("ATTRIBUTE 8");
                        CurrPage.Update();
                    end;
                }
                field("Fabric Code "; gtextFabricCode)
                {
                    ApplicationArea = All;
                    Editable = true;
                    ...
                    begin
                        if gtextThickness <> '' then
                            SetRange("ATTRIBUTE 9", gtextFabricCode)
                        else
                            SetRange("ATTRIBUTE 9");
                        CurrPage.Update();
                    end;
                }
            }
    ...
    protected var
        ...
        gtextMaterial: Text;
        gtextItemCatCode: Text;
        gtextProdGrpCode: Text;
        gtextFormat: Text;
        gtextColour: Text;
        gtextFinish: Text;
        gtextDimension: Text;
        gtextThickness: Text;
        gtextLampholder: text;
        gtextWattage: text;
        gtextFabricCode: Text;
